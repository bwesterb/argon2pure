    ...
    def test_base_parameters(self):
        for time_cost in range(1, 2):
            for parallelism in range(1, 2):
                for memory_cost in range(
                        8 * parallelism, 8 * parallelism + 10):
...
class TestBlake2b(unittest.TestCase):
    ...
    def test_blake2b_keyed(self):
        ...
        self.assertEqual(
            binascii.hexlify(cur),
            b'ce91a1c91d8865a36c090c576a3f99d2b5e3e29cd17b35fdb919bf1ee640f5b'
            b'12285d26e9727b48c4004624b83d6bdea3e3354e491e2ffb40b1517cc39ba9b'
            b'97')
    ...
    def test_blake2b_unkeyed(self):
        ...
        self.assertEqual(
            argon2pure.Blake2b(cur).hexdigest(),
            b'fbf206a49876bb827af18cd6ddacb72ad017570984126d184138ac7a0463592'
            b'587b66c9f380ce661861be15d19d5b8a15ad165126a007819f00db0148e71ca'
            b'39')

    def test_blake2b_various(self):
        cur = b'!'
        for i in range(1, 64):
            cur = argon2pure.Blake2b(
                cur, digest_length=i, key=cur[
                    :i]).digest()
        self.assertEqual(
            binascii.hexlify(cur),
